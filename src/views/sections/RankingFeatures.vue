<template>
  <base-section
    id="ranking-features"
  >
    <base-section-heading :title="$t('Ranking.title')">
      {{ $t('Ranking.subtitle') }}
    ...
    methods: {
      ...
      fakeApiCall () {
        return new Promise((resolve, reject) => {
          ...
          this.axios
            .post('/apiv2/web/GetRanking', { page: page, itemsPerPage: itemsPerPage })
            .then(response => {
              const items = []
              ...
              for (const data of response.data.data) {
                ...
                if (this.users.findIndex(a => { return a.steam3 === data.steamid }) === -1) {
                  ...
                  this.axios
                    .post('/apiv2/web/GetUserInfo', { steamId: data.steamid })
                    .then(userresponse => {
